...
def student_dashboard():
    ...
    for i,sub_node in enumerate(subjects):
        ...
        def unenroll_button(sid=sid,name=sub['name']):
            if st.button("Uneneroll From This Subject",type='tertiary',width='stretch',icon=':material/delete_forever:'):
...
def student_screen():
    ...
    if show_registration:
        with st.container(border=True):
            st.header("Register Yourself")
            new_name=st.text_input("Enter Your Name",placeholder='E.g. Y Sidhartha')
            st.divider()
